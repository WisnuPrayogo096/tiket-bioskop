...
<div id="teks"><hr/>
		...
		<form method="post" action="deleteUser.php">
			<table border="0">
				<tr>
					...
					<td>
						<input type="text" name="delNamaUser" placeholder="Nama user yang akan dihapus" style="width: 200px; padding-right: 20px;" />
					</td>
					<td>
		...
		<br>
		<button class="button" onclick="window.location.href='daftar.php'">Tambah User Baru</button>
