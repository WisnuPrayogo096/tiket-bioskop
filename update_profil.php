...
<h3 align="left"><u style="text-decoration: none;">Form Update Profil </u></h3>
...
<tr><td>Username</td><td>:</td><td><input type="text" name="user" size="25" value="<?php echo $user;?>"></td></tr>
...
<tr><td colspan="3"><input type="submit" name="submit" value="Update Profil"><input type="reset" value="Reset"><input type="button" value="Back" onclick="window.history.back();">
</td></tr>
</table>
</form>
